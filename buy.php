...
<hr>
  <!-- k1 section start--->
   <div class="k1">
        <nav>
      <h5 class="logo">Bid<a href="file:///C:/Users/komal/OneDrive/Desktop/DE_Project/index.html" style="text-decoration: none;"><span>Up</span></a></h5>
      <ul>
...
<!--aayuverdic product-->
 <div class="AayuvedicProduct">
            ...
            <p><button class="btn-2"><a href="delivery-details.html">BUY NOW</a></button></p>
            </div>
            <?php $sn++;}} else { ?>
            <div class="product">
